...
public class Text {
	...
	static String f42 = "Paladset: Du tilbringer dagen som levende statue foran paladset i håbet om at tjene lidt penge på det. Da du fejler miserabelt beslutter du dig for at stjæle en forbipasserende munks indsamlingsbøsse og gemmer dig i en rosebusk i stedet. +100";
	static String f43 = "Paladset: Det er Prinsesse Guldtås fødselsdag! Som den gode borger du er, tropper du op foran paladsets porte iført flag, bøllehat, balloner, banner og truthorn, mens du skriger lykønskninger i kor med de andre. Prinsesse Guldtå kommer ud på balkonen og takker jer. +100";

	static String f51 = "Ørkenen: I din søgen har du formået at rode dig ud i en skidekold ørken. Efter mange timers vandren ser du en oase. Da du kommer nærmere viser det sig at oasen var et fatamorgana, og at du rent faktisk står i en telefonboks. Du benytter lejligheden til at ringe efter en taxa. -20";
	...
	static String f53 = "Ørkenen: Ak ja, det er ikke nemt at ridde på kamel. Ikke nok med, at du mistede kontrollen over dyret midt ude i ørkenen, så faldt du også af og modtog samtlige brandsår af det brændvarme sand. Op på kamelen igen! -20.";

	static String f61 = "Fortet: Du hiver din lut frem over giver dig i kast med din fortolkning af 'Wonderwall' i håbet om at nogen vil betale dig for at holde op igen. Lidt senere er der gået sport i at kyle kobberstykker efter dig, og selvom du har erhvervet dig en del blå mærker har du reddet dig en god stak ca$h. +180";
	...
	static String f63 = "Fortet: Din kære udkårne er blevet taget til fange af den frygtigelige orc, Oghuglat, som har låst hende inde i et fort! For at redde hende må du finde en måde at komme over den høje stenmur på. Det er her meget belejligt, at du opfinder stigen og tjener kassen på det. +180.";
	...
	static String f73 = "Klosteret: Efter at have set filmen 'Sister Act' beslutter du dig for at gøre det samme, og vie dit liv til vor Herre i klosteret. Men langomt går det op for dig, at du netop ikke er Whoopi Goldberg, og at det faktisk er lidt småkedeligt at sidde og være en jomfruelig kvinde klædt i sort. +0";
	...
	static String f83 = "Den Sorte Grotte: Fulde mennesker fylder gaden, og du trasker forventningsfuld frem med dine venner, der har overbevist dig om, at det går ned i Den Sorte Grotte i aften. Det er kulsort i den Sorte Grotte, og du kan ingenting se. Du bliver derfor smidt ud af dørmændene for at tisse på dansegulvet. -70";
	...
	static String f93 = "Hytten: Med forfrysniger i tæerne kravler du dig igennem sneen, udsultet og træt. Da mørket falder på, tror du, at spillet er ude. Pludselig griber en stor skikkelse fat i dag og slæber dig ind i en træhytte. Det viser sig, at den afskyelige snemand lige har reddet dig, og tilmed byder på kamillete. +60";

	static String f101 = "Varmuren: Mens du forsøger at forhandle en handlende ned på en pris du burde skamme dig over, ser du en flok behårede væsener, der kommer gående over markedspladsen. Du ser dit engangsknald fra tidligere i blandet dem og skynder dig væk. Du glemmer din pung. -80, Ekstra tur";
	static String f102 = "Varmuren: Du vågner i en seng med tømmermænd. Lugten af våd hund hænger i luften og der sover en stor, pelset skikkelse ved siden af dig. Med en stor erfaring sniger du dig ud ad sengen og ud ad et vindue. Du efterlader en håndfuld krøllede sedler på sengebordet. Man er vel gentleman. -80, Ekstratur";
	static String f103 = "Varmuren: Valfred, alfa i vareulveflokken, har annonceret månedens kamp. Det viser sig, at du skal deltage og tilmed kæmpe mod den fæle Rannulfus! Du snyder under kampen og kaster sølvpulver på din modstander. Valfred er rasende, og befaler, at det er en omkamp. -70, ekstratur";
