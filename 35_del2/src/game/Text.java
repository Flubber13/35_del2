...
public class Text {
	...
	static String f33 = "Vulkankrateret: Det er efterhånden lang tid siden, at du har været på sightseeing. Du vælger at tage til det legendariske vulkankrater, Wydek, hvilket nok er den mest spændende attraktion, ifølge din oldemors telefonbog. Turen var fin, selvom du praktisk talt bare kiggede ned i et stort hul. -100";
	...
	static String f103 = "Varemuren: Valfred, alfa i vareulveflokken, har annonceret månedens kamp. Det viser sig, at du skal deltage og tilmed kæmpe mod den fæle Rannulfus! Du snyder under kampen og kaster sølvpulver på din modstander. Valfred er rasende, og befaler, at det er en omkamp. -70, men du får en tur mere.";
